...
def edit_user(user_id, new_password, new_role, new_first, new_last, new_phone, new_address, new_skill=None):
    try:
    ...
    if not(isinstance(new_skill, str) or new_skill == "" or new_skill is None):
        return False
